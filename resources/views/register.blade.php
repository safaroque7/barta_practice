                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="first_name" name="first_name" type="text" autocomplete="first_name"
                            ...
                            class="block w-full rounded-md border p-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6 @error('first_name') border-red-500 @enderror" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="w-100">
                        <textarea name="bio" id="bio" cols="30" rows="5"
                            class="block w-full rounded-md border-0 p-2 p-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300"></textarea>
                    </div>
                </div>
